...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pyiron_base-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pyiron_base-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add pyiron_base
# for installing globally
pixi global install pyiron_base
```
...
It is possible to list all of the versions of `pyiron_base` available on your platform:
...
```
pixi search pyiron_base --channel conda-forge
```
